...
if (isset($_POST['add'])) {
    ...
    if(isset($_FILES['images']) && $_FILES['images']['error'] === UPLOAD_ERR_OK) {
        ...
        $sql = "INSERT INTO items (item_name, own_price, comp_price1, comp_price2, comp_price3, comp_price4) 
                VALUES ('$item_name', '$own_price', '$comp_price1', '$comp_price2', '$comp_price3', '$comp_price4')";
...
header('Location: admin_view.php'); // Change to the appropriate page
exit; // Terminate script execution
?>