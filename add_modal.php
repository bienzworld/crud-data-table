    ...
    <div class="modal-dialog">
        <div class="modal-content">
			...
			<form method="POST" action="add.php">
				...
				<div class="row form-group">
					<div class="col-sm-2">
						<label class="control-label modal-label">Comptetitor Price 1:</label>
					</div>
					<div class="col-sm-10">
				...
				<div class="row form-group">
					<div class="col-sm-2">
						<label class="control-label modal-label">Comptetitor Price 2:</label>
					</div>
					<div class="col-sm-10">
				...
				<div class="row form-group">
					<div class="col-sm-2">
						<label class="control-label modal-label">Comptetitor Price 3:</label>
					</div>
					<div class="col-sm-10">
				...
				<div class="row form-group">
					<div class="col-sm-2">
						<label class="control-label modal-label">Comptetitor Price 4:</label>
					</div>
					<div class="col-sm-10">
